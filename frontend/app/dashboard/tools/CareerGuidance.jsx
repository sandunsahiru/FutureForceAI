...
export default function CareerGuidance() {
  ...
  const analyzeCareerPath = async () => {
    ...
    try {
      ...
      // Set success message
      setSuccess("Career analysis completed successfully!");
      ...
      <div className="space-y-8">
                      ...
                      >
                        <div>
                          ...
                          <div className="text-sm text-gray-600">
                            {new Date(cv.uploadedAt).toLocaleDateString()} • {Math.round(cv.fileSize / 1024)} KB
                          </div>
                        </div>
                      </button>
                    </li>
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              {predefinedInterests.map((interest) => (
                <button
                  ...
                  className={`px-3 py-1.5 rounded-full text-sm font-medium transition-colors ${careerInterests.includes(interest)
              ...
              <div className="flex flex-wrap gap-2">
                {workPriorities.map((priority) => (
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-full text-sm font-medium transition-colors ${careerGoals.priorities?.includes(priority)
        ...
        {careerAnalysis && (
          <div ref={resultsRef} className="mt-8 border-t pt-8">
            ...
            {/* Navigation Tabs - with improved overflow handling */}
            <div className="border-b border-gray-200 mb-6">
              <nav className="-mb-px flex space-x-8 overflow-x-auto">
                <button
                  onClick={() => setActiveTab('overview')}
                  className={`pb-4 px-1 border-b-2 font-medium text-sm whitespace-nowrap ${activeTab === 'overview'
                ...
                <button
                  ...
                  className={`pb-4 px-1 border-b-2 font-medium text-sm whitespace-nowrap ${activeTab === 'paths'
                      ? 'border-purple-500 text-purple-600'
                      : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                    }`}
                >
                ...
                <button
                  ...
                  className={`pb-4 px-1 border-b-2 font-medium text-sm whitespace-nowrap ${activeTab === 'skills'
                      ? 'border-purple-500 text-purple-600'
                      : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                    }`}
                >
                ...
                <button
                  ...
                  className={`pb-4 px-1 border-b-2 font-medium text-sm whitespace-nowrap ${activeTab === 'resources'
                      ? 'border-purple-500 text-purple-600'
                      : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                    }`}
                >
            ...
            {console.log("Learning Resources:", learningResources)}

            {/* Tab Content with improved error handling */}
            {activeTab === 'overview' && (
              <div className="space-y-6">
                ...
                <div className="bg-purple-50 p-6 rounded-lg">
                  ...
                  <p className="text-gray-700 mb-4">{careerAnalysis?.summary || "No summary available."}</p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="bg-white p-4 rounded-lg shadow-sm">
                      ...
                      <div className="text-lg font-bold">{careerAnalysis?.growthPotential || "Not available"}</div>
                    </div>
                    <div className="bg-white p-4 rounded-lg shadow-sm">
                      <div className="text-purple-600 font-semibold mb-1">Market Demand</div>
                      <div className="text-lg font-bold">{careerAnalysis?.marketDemand || "Not available"}</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-green-50 p-6 rounded-lg">
                  ...
                  {Array.isArray(careerAnalysis?.strengths) && careerAnalysis.strengths.length > 0 ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {careerAnalysis.strengths.map((strength, index) => (
                        <div key={index} className="flex items-start">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-gray-600">{strength.description || "No description available."}</div>
                          </div>
                        </div>
                      ))}
                    </div>
                  ) : (
                    <p className="text-gray-600">No strengths information available.</p>
                  )}
                </div>
                ...
                <div className="bg-orange-50 p-6 rounded-lg">
                  ...
                  {Array.isArray(careerAnalysis?.improvements) && careerAnalysis.improvements.length > 0 ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {careerAnalysis.improvements.map((area, index) => (
                        <div key={index} className="flex items-start">
                          <AlertCircle className="mr-2 h-5 w-5 text-orange-600 flex-shrink-0 mt-0.5" />
                          <div>
                            <div className="font-medium">{area.title || "Area"}</div>
                            <div className="text-sm text-gray-600">{area.description || "No description available."}</div>
                          </div>
                        </div>
                      ))}
                    </div>
                  ) : (
                    <p className="text-gray-600">No improvement areas information available.</p>
                  )}
                </div>
              </div>
            )}
              ...
              <div className="space-y-6">
                {Array.isArray(careerPaths) && careerPaths.length > 0 ? (
                  careerPaths.map((path, index) => (
                    <div key={index} className="border border-gray-200 rounded-lg p-6">
                      <div className="flex items-start justify-between mb-4">
                        <div>
                          <h4 className="text-xl font-semibold text-gray-800">{path.title || "Career Path"}</h4>
                          <p className="text-gray-600 mt-1">{path.description || "No description available."}</p>
                        </div>
                        <div className={`px-3 py-1 rounded-full text-sm font-medium ${path.fitScore >= 80 ? 'bg-green-100 text-green-800' :
                            path.fitScore >= 60 ? 'bg-yellow-100 text-yellow-800' :
                              'bg-red-100 text-red-800'
                          }`}>
                          {path.fitScore || 0}% Match
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                          ...
                          {Array.isArray(path.reasons) && path.reasons.length > 0 ? (
                            ...
                            <p className="text-gray-600">No reasons information available.</p>
                          )}
                        </div>

                        <div>
                          <h5 className="font-medium text-gray-700 mb-2">Challenges to Consider:</h5>
                          {Array.isArray(path.challenges) && path.challenges.length > 0 ? (
                            <ul className="space-y-1">
                            ...
                            <p className="text-gray-600">No challenges information available.</p>
                          )}
                        </div>
                      </div>
                      ...
                      <div className="mt-4">
                        ...
                        {Array.isArray(path.progression) && path.progression.length > 0 ? (
                          <div className="flex items-center space-x-2 overflow-x-auto py-2 mt-2">
                            {path.progression.map((step, idx) => (
                              <React.Fragment key={idx}>
                                <div className="text-center flex-shrink-0">
                                  <div className="bg-purple-100 text-purple-700 rounded-lg px-3 py-2 text-sm font-medium whitespace-nowrap">
                                    {step.role || "Role"}
                                  </div>
                                  <div className="text-xs text-gray-500 mt-1">{step.years || "Varies"}</div>
                                </div>
                          ...
                          <p className="text-gray-600">No progression information available.</p>
                        )}
                      </div>
                      ...
                      <div className="mt-4 pt-4 border-t border-gray-200">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          <div>
                            ...
                            <div className="text-lg font-semibold text-gray-900">{path.salary || "Not available"}</div>
                          </div>
                          <div>
                            <span className="text-sm font-medium text-gray-600">Job Growth:</span>
                            <div className="text-lg font-semibold text-gray-900">{path.growth || "Not available"}</div>
                          </div>
                          <div>
                            <span className="text-sm font-medium text-gray-600">Time to Transition:</span>
                            <div className="text-lg font-semibold text-gray-900">{path.timeToTransition || "Not available"}</div>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="text-center py-10 bg-gray-50 rounded-lg">
                    ...
                    <h4 className="text-lg font-medium text-gray-700 mb-2">No Career Paths Available</h4>
                    <p className="text-gray-500 max-w-md mx-auto">We couldn't generate career paths based on the provided information. Please try again with more detailed career interests.</p>
                  </div>
                )}
              </div>
            )}
            ...
            {activeTab === 'skills' && (
              <div className="space-y-6">
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                  ...
                  {Array.isArray(careerAnalysis?.currentSkills) && careerAnalysis.currentSkills.length > 0 ? (
                    <div className="space-y-4">
                      {careerAnalysis.currentSkills.map((skill, index) => (
                        <div key={index} className="flex items-center justify-between">
                          ...
                          <div className="flex items-center space-x-2">
                            {renderSkillLevel(skill.level || "Beginner")}
                            <span className="text-sm text-gray-500">{skill.level || "Beginner"}</span>
                          </div>
                        </div>
                      ))}
                    </div>
                  ) : (
                    <p className="text-gray-600">No current skills information available.</p>
                  )}
                </div>
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                  ...
                  {Array.isArray(skillGaps) && skillGaps.length > 0 ? (
                      ...
                      {skillGaps.map((gap, index) => (
                        <div key={index} className="border-b border-gray-200 pb-4 last:border-0">
                          <div className="flex justify-between items-center mb-2">
                            <h5 className="font-medium text-gray-800">{gap.skill || "Skill Gap"}</h5>
                            <span className={`px-2 py-1 rounded text-sm ${gap.priority === 'High' ? 'bg-red-100 text-red-700' :
                            ...
                            <div className="flex-1">
                              ...
                              <div className="h-2 bg-gray-200 rounded-full relative">
                                <div
                                  ...
                                  style={{ width: `${(gap.currentLevel || 0) * 20}%` }}
                                ></div>
                                <div
                                  className="absolute h-2 border-2 border-purple-700 rounded-full"
                                  style={{ width: `${(gap.requiredLevel || 0) * 20}%`, background: 'transparent' }}
                                ></div>
                              </div>
                            </div>
                          </div>
                          <p className="text-sm text-gray-600 mb-2">{gap.importance || "Important skill for your career path."}</p>
                          <div className="text-sm text-purple-600">
                            Recommended Learning: {gap.learningPath || "Explore online courses and practice projects."}
                          </div>
                        </div>
                      ))}
                    </div>
                    ...
                    <div className="text-center py-8">
                      ...
                      <h5 className="text-lg font-medium text-gray-700 mb-2">No Significant Skill Gaps Found</h5>
                      <p className="text-gray-500 max-w-md mx-auto">
                        Your current skillset appears to be well-aligned with your career interests.
                        Continue developing your existing skills to maintain your competitive edge.
                      </p>
                    </div>
                  )}
                </div>
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                  ...
                  {Array.isArray(careerAnalysis?.futureSkills) && careerAnalysis.futureSkills.length > 0 ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {careerAnalysis.futureSkills.map((skill, index) => (
                        <div key={index} className="flex items-start p-3 bg-blue-50 rounded-lg">
                          ...
                          <div>
                            <div className="font-medium text-gray-800">{skill.name || "Skill"}</div>
                            <div className="text-sm text-gray-600">{skill.reason || "Important for future career growth."}</div>
                            <div className="text-xs text-blue-600 mt-1">
                              Market Demand: {skill.marketDemand || "Growing"}
                            </div>
                          </div>
                        </div>
                      ))}
                    ...
                    <p className="text-gray-600">No future skills information available.</p>
                  )}
                </div>
              </div>
            )}
            ...
            {activeTab === 'resources' && (
              <div className="space-y-6">
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                  ...
                  {Array.isArray(learningResources?.paths) && learningResources.paths.length > 0 ? (
                    <div className="space-y-4">
                      {learningResources.paths.map((path, index) => (
                        <div key={index} className="border border-gray-200 rounded-lg p-4">
                          <div className="flex justify-between items-start mb-2">
                            <div>
                              <h5 className="font-medium text-gray-800">{path.title || "Learning Path"}</h5>
                              <p className="text-sm text-gray-600">{path.description || "No description available."}</p>
                            </div>
                            <span className="px-2 py-1 bg-green-100 text-green-700 rounded text-sm">
                              {path.duration || "Varies"}
                            </span>
                          </div>
                          <div className="mt-3">
                            <div className="text-sm font-medium text-gray-700 mb-2">Key Topics:</div>
                            {Array.isArray(path.topics) && path.topics.length > 0 ? (
                              <div className="flex flex-wrap gap-2">
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                  ...
                  {Array.isArray(learningResources?.courses) && learningResources.courses.length > 0 ? (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div key={index} className="border border-gray-200 rounded-lg p-4">
                          ...
                          {course.rating && (
                            <div className="flex items-center text-sm text-amber-600 mb-2">
                              ...
                              {course.reviews && <span className="text-gray-500 ml-1">({course.reviews})</span>}
                            </div>
                          )}
                          <div className="flex justify-between items-center">
                            <span className="text-sm text-gray-600">{course.duration || "Varies"}</span>
                            <span className={`px-2 py-1 rounded text-sm ${course.level === 'Beginner' ? 'bg-green-100 text-green-700' :
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                  ...
                  {Array.isArray(learningResources?.certifications) && learningResources.certifications.length > 0 ? (
                    <div className="space-y-4">
                      {learningResources.certifications.map((cert, index) => (
                        <div key={index} className="flex items-start p-4 border border-gray-200 rounded-lg">
                          ...
                          <div className="flex-1">
                            <h5 className="font-medium text-gray-800">{cert.name || "Certification"}</h5>
                            <p className="text-sm text-gray-600 mt-1">{cert.description || "No description available."}</p>
                            <div className="flex flex-wrap items-center mt-2 text-sm text-gray-500 gap-2">
                              <span>Provider: {cert.provider || "Various"}</span>
                              <span className="hidden md:inline">•</span>
                              <span>Duration: {cert.duration || "Varies"}</span>
                              {cert.cost && (
                                <>
                                  <span className="hidden md:inline">•</span>
            ...
            <div className="mt-8 bg-gradient-to-r from-purple-600 to-blue-600 rounded-lg p-6 text-white">
              ...
              {Array.isArray(careerAnalysis?.actionPlan) && careerAnalysis.actionPlan.length > 0 ? (
                <div className="space-y-4">
                  {careerAnalysis.actionPlan.map((step, index) => (
                    <div key={index} className="flex items-start">
                      ...
                      <div className="ml-4">
                        <h5 className="font-semibold">{step.title || `Step ${index + 1}`}</h5>
                        <p className="text-white/80 text-sm mt-1">{step.description || "No description available."}</p>
                        <div className="text-white/60 text-xs mt-1">Timeline: {step.timeline || "Ongoing"}</div>
                      </div>
                    </div>
                  ))}
                </div>
              ) : (
                <p className="text-white/80">No action plan available. Please try analyzing your career path again.</p>
              )}
            </div>
